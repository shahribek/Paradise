...
/mob/living/carbon/human/verb/emote_twirl()
	set name = "○ Вертеть в руках "
	set category = VERB_CATEGORY_EMOTIONS
...
/mob/living/carbon/human/verb/emote_johnny()
	set name = "◦ Выпустить Джонни "
	set category = VERB_CATEGORY_EMOTIONS
	emote("johnny", intentional = TRUE)
...
/mob/living/carbon/human/proc/emote_hiss_tajaran()
	set name = "< Шипеть >"
	set category = VERB_CATEGORY_EMOTIONS
