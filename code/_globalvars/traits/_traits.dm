...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	// MARK: /mob
	/mob = list(
		"TRAIT_ABSOLUTE_VIRUSIMMUNE" = TRAIT_ABSOLUTE_VIRUSIMMUNE,
		"TRAIT_ACID_PROTECTED" = TRAIT_ACID_PROTECTED,
		"TRAIT_ADVANCED_CYBERIMPLANTS" = TRAIT_ADVANCED_CYBERIMPLANTS,
		"TRAIT_AI_BAGATTACK" = TRAIT_AI_BAGATTACK,
		"TRAIT_AI_UNTRACKABLE" = TRAIT_AI_UNTRACKABLE,
		"TRAIT_AIRLOCK_HIT" = TRAIT_AIRLOCK_HIT,
		"TRAIT_ANTI_STUN_REAGENT" = TRAIT_ANTI_STUN_REAGENT,
		...
		"TRAIT_BLOB_ZOMBIFIED" = TRAIT_BLOB_ZOMBIFIED,
		"TRAIT_BLOODCRAWL" = TRAIT_BLOODCRAWL,
		"TRAIT_BLOODCRAWL_EAT" = TRAIT_BLOODCRAWL_EAT,
		"TRAIT_BURNING_STAMINA" = TRAIT_BURNING_STAMINA,
		...
		"TRAIT_CYBERIMP_IMPROVED" = TRAIT_CYBERIMP_IMPROVED,
		...
		"TRAIT_FAKE_FIRE" = TRAIT_FAKE_FIRE,
		...
		"TRAIT_HAS_CARBON_REGENERATION" = TRAIT_HAS_CARBON_REGENERATION,
		...
		"TRAIT_LUNGE_HAS_ATTACKED" = TRAIT_LUNGE_HAS_ATTACKED,
		...
		"TRAIT_OBSERVING_INVENTORY" = TRAIT_OBSERVING_INVENTORY,
		...
		"TRAIT_TOXIC_FUEL_PROTECTED" =  TRAIT_TOXIC_FUEL_PROTECTED,
		...
		"TRAIT_WEAK_MUSCULS" = TRAIT_WEAK_MUSCULS,
		"TRAIT_WEAK_PULLING" = TRAIT_WEAK_PULLING,
		"TRAIT_WET_IMMUNITY" = TRAIT_WET_IMMUNITY,
