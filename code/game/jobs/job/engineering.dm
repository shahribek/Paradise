/datum/job/head_of_staff/chief_engineer
	...
	skillset = list(
		SKILL_EXOSUIT_CONTROL = SKILL_LEVEL_ADVANCED,
		SKILL_MOD_CONTROL = SKILL_LEVEL_ADVANCED,
		SKILL_ACCURACY = SKILL_LEVEL_BEGINNER,
		SKILL_RANGED_WEAPONS = SKILL_LEVEL_BEGINNER,
		SKILL_MELEE_WEAPONS = SKILL_LEVEL_BEGINNER,
		SKILL_BUILDING = SKILL_LEVEL_PROFESSIONAL,
		SKILL_CONSTRUCTION = SKILL_LEVEL_PROFESSIONAL,
		SKILL_ELECTRICAL = SKILL_LEVEL_PROFESSIONAL,
		SKILL_ATMOS = SKILL_LEVEL_PROFESSIONAL,
		SKILL_HACKING = SKILL_LEVEL_PROFESSIONAL,
	)
