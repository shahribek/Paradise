...
/obj/item/melee/clock_sword/proc/reset_swordsman(mob/user)
	to_chat(user, span_notice("The grip on [src] looses..."))
...
/obj/item/clockwork/clocklock
	name = "clock lock"
	desc = "Маленький часовой механизм, используемый для запирания спусковых механизмов любого огнестрельного оружия \
